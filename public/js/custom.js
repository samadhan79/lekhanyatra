...
"use strict";
		...
		$(".fancybox").fancybox({				
				...
				autoResize: true,
				/*afterLoad: function() {
					console.log($(this.element).attr('temp'));
					this.title = $(this.element).attr('title');
					this.title = '<h4>' + this.title + '</h4>' + '<p><a href="' + this.temp + '">Download</a> </p><p>' + $(this.element).parent().find('img').attr('alt') + '</p>';
					//this.title = '<a href="' + this.href + '">Download</a> ' + this.title;
				},*/
				beforeShow: function () {
					/*var site_link = $(this.element).attr('site_link');
					if(site_link)
						var site_link = '<p><a href=' + $(this.element).attr('site_link') + '>Site link</a></p>';
					//console.log($(this.element).attr('site_link'));
					
					var play_store_link = $(this.element).attr('play_store_link');
					if(play_store_link)
						var play_store_link = '<p><a href=' + $(this.element).attr('play_store_link') + '>App store link</a></p>';
					
					var app_store_link = $(this.element).attr('app_store_link');
					if(app_store_link)
						var app_store_link = '<p><a href=' + $(this.element).attr('app_store_link') + '>Play store link</a></p>';*/
